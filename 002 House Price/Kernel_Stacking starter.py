...
SEED = 0
NROWS = None
SUBMISSION_FILE = 'E:/Tinky/大学课件及作业/6 自学课/6-3.Kaggle竞赛/C2_房价预测/submission_X1.csv'

#3
## Load the data ##
f1=open("E:/Tinky/大学课件及作业/6 自学课/6-3.Kaggle竞赛/C2_房价预测/train.csv")
train = pd.read_csv(f1)
f2=open("E:/Tinky/大学课件及作业/6 自学课/6-3.Kaggle竞赛/C2_房价预测/test.csv")
test = pd.read_csv(f2)
