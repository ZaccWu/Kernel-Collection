...
#4
f1=open("E:/Tinky/大学课件及作业/6 自学课/6-3.Kaggle竞赛/房价预测/train.csv")
f2=open("E:/Tinky/大学课件及作业/6 自学课/6-3.Kaggle竞赛/房价预测/test.csv")
...
print(full.isnull().sum()[full.isnull().sum()>0])#checking remaining missing data
...
#16
#a long list of value-mapping.
#build as many features as possible and trust the model to choose the right features. So groupby SalePrice according to one feature and sort it based on mean and median. Here is an example:
...
#47
#When we use 2 methods we get better score
...
result.to_csv("E:/Tinky/大学课件及作业/6 自学课/6-3.Kaggle竞赛/房价预测/submission_X.csv",index=False)